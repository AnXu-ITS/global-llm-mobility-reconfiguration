...
const require=createRequire('C:/Users/user/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/node_modules/_entry.cjs');
const sharp=require('sharp');
const here=path.dirname(fileURLToPath(import.meta.url)), assets=path.join(path.dirname(here),'hybrid_assets');
await fs.mkdir(assets,{recursive:true});
const gen='C:/Users/user/.codex/generated_images/01a0912c-5c72-7f53-97b4-8370d1ea0062';
