...
![Figure 1: architecture](figures/fig01_architecture.png)
...
![Figure 2: sites](figures/fig02_sites.png)
...
**Table 3. Network and reference-service descriptors.**
...
| Intersection density (km⁻²) | 38.770 | 101.758 | 40.918 |
...
![Figure 3: e1 coordination](figures/fig03_e1_coordination.png)
...
**Table 5. E1 service outcomes: mean [95% interval].**
...
![Figure 4: candidate ablation](figures/fig04_candidate_ablation.png)
...
**Table 6. Paired E1 candidate-interface ablation: B4b minus B4a.**
...
![Figure 5: e2 recovery](figures/fig05_e2_recovery.png)
...
**Table 7. E2 all-run transport outcomes and conditional path restoration.**
...
**Table 8. Selected E2 paired comparisons: B4b minus B2.**
...
![Figure 6: e3 compound](figures/fig06_e3_compound.png)
...
**Table 9. Mean E3 system weighted loss by disturbance/task level.**
...
![Figure 7: operational](figures/fig07_operational.png)
...
**Table 10. E4A observation scheduling, completion and B4b input demand.**
...
**Table 11. E4B injected execution delay and mean completion duration.**
...
![Figure 8: execution timeline](figures/fig08_execution_timeline.png)
...
**Table 12. E4C B4b input burden with an unchanged core fleet.**
...
1. Mattsson, L.-G., and Jenelius, E. (2015). Vulnerability and resilience of transport systems—A discussion of recent research. *Transportation Research Part A: Policy and Practice*, 81, 16–34. [DOI](https://doi.org/10.1016/j.tra.2015.06.002).

2. Jenelius, E., and Mattsson, L.-G. (2015). Road network vulnerability analysis: Conceptualization, implementation and application. *Computers, Environment and Urban Systems*, 49, 136–147. [DOI](https://doi.org/10.1016/j.compenvurbsys.2014.02.003).

3. Cats, O., and Jenelius, E. (2018). Beyond a complete failure: the impact of partial capacity degradation on public transport network vulnerability. *Transportmetrica B: Transport Dynamics*, 6(2), 77–96. [DOI](https://doi.org/10.1080/21680566.2016.1267596).

4. Pillac, V., Gendreau, M., Guéret, C., and Medaglia, A. L. (2013). A review of dynamic vehicle routing problems. *European Journal of Operational Research*, 225(1), 1–11. [DOI](https://doi.org/10.1016/j.ejor.2012.08.015).

5. Lai, D. S. W., and Leung, J. M. Y. (2018). Real-time rescheduling and disruption management for public transit. *Transportmetrica B: Transport Dynamics*, 6(1), 17–33. [DOI](https://doi.org/10.1080/21680566.2017.1358678).

6. Murray, C. C., and Chu, A. G. (2015). The flying sidekick traveling salesman problem: Optimization of drone-assisted parcel delivery. *Transportation Research Part C: Emerging Technologies*, 54, 86–109. [DOI](https://doi.org/10.1016/j.trc.2015.03.005).

7. Federal Aviation Administration (2023). *Urban Air Mobility Concept of Operations, Version 2.0*. [Official report](https://www.faa.gov/sites/faa.gov/files/Urban-Air-Mobility-Concept-of-Operations-2.0.pdf).

8. Wabersich, K. P., and Zeilinger, M. N. (2021). A predictive safety filter for learning-based control of constrained nonlinear dynamical systems. *Automatica*, 129, 109597. [DOI](https://doi.org/10.1016/j.automatica.2021.109597).

9. Ichter, B., et al. (2023). Do As I Can, Not As I Say: Grounding Language in Robotic Affordances. *Proceedings of the 6th Conference on Robot Learning*, Proceedings of Machine Learning Research, 205, 287–318. [Proceedings](https://proceedings.mlr.press/v205/ichter23a.html).

10. Lai, S., Xu, Z., Zhang, W., Liu, H., and Xiong, H. (2024). LLMLight: Large Language Models as Traffic Signal Control Agents. *arXiv*, 2312.16044, version 5. [Preprint](https://arxiv.org/abs/2312.16044v5).

11. Liu, N. F., Lin, K., Hewitt, J., Paranjape, A., Bevilacqua, M., Petroni, F., and Liang, P. (2024). Lost in the Middle: How Language Models Use Long Contexts. *Transactions of the Association for Computational Linguistics*, 12, 157–173. [Article](https://aclanthology.org/2024.tacl-1.9/).

12. Alvarez Lopez, P., Behrisch, M., Bieker-Walz, L., Erdmann, J., Flötteröd, Y.-P., Hilbrich, R., Lücken, L., Rummel, J., Wagner, P., and Wießner, E. (2018). Microscopic Traffic Simulation using SUMO. *21st IEEE International Conference on Intelligent Transportation Systems*, 2575–2582. [DOI](https://doi.org/10.1109/ITSC.2018.8569938).

13. Hoekstra, J. M., and Ellerbroek, J. (2016). BlueSky ATC Simulator Project: An Open Data and Open Source Approach. *7th International Conference on Research in Air Transportation*. [Institutional record](https://resolver.tudelft.nl/uuid:d1131a90-f0ea-4489-a217-ad29987689a1).

14. Haklay, M., and Weber, P. (2008). OpenStreetMap: User-Generated Street Maps. *IEEE Pervasive Computing*, 7(4), 12–18. [Institutional record](https://discovery.ucl.ac.uk/id/eprint/13849/).

15. Wilcoxon, F. (1945). Individual Comparisons by Ranking Methods. *Biometrics Bulletin*, 1(6), 80–83. [DOI](https://doi.org/10.2307/3001968).
...
17. Wilson, E. B. (1927). Probable Inference, the Law of Succession, and Statistical Inference. *Journal of the American Statistical Association*, 22(158), 209–212. [DOI](https://doi.org/10.1080/01621459.1927.10502953).

18. Holm, S. (1979). A Simple Sequentially Rejective Multiple Test Procedure. *Scandinavian Journal of Statistics*, 6(2), 65–70. [Article record](https://www.jstor.org/stable/4615733).
...
**Table B1. Aggregate E3 outcomes across the 12-scenario panel.**
