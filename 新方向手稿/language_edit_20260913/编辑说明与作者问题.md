...
| 文档 | 原稿 | 编辑稿 | 变化 |
|---|---:|---:|---:|
| main.tex | 7137 | 7410 | +273 |
| supplement.tex | 1836 | 1898 | +62 |

| Results 小节 | 原稿 | 编辑稿 | 变化 |
|---|---:|---:|---:|
| Selective air support and incumbent-service cost | 213 | 231 | +18 |
| The candidate interface shapes supervisory choices | 256 | 269 | +13 |
| Restored paths do not guarantee timely recovery | 186 | 194 | +8 |
| Compound service loss depends on surviving options | 215 | 229 | +14 |
| Contrasting morphology and policy sensitivity | 120 | 139 | +19 |
| Timing conditions and input burden | 465 | 510 | +45 |
